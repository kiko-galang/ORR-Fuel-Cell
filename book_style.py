...
Import this AFTER customplot in any script that still needs customplot's
color-swatch utilities; book_style's rcParams.update() call always wins,
since it runs at import time and is not undone by anything customplot does.
